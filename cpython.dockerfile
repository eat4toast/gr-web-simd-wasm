FROM build-base:dev
RUN /bin/bash /opt/emsdk/emsdk_env.sh
RUN echo $PATH
# clone cpython 3.11
...
RUN cp /opt/cpython/wasm/lib/python3.11/_sysconfigdata_d_linux_.py /opt/cpython/wasm/lib/python3.11/_sysconfigdata_d_linux_x86_64-linux-gnu.py
